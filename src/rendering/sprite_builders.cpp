...
sprite::sprite sprite_builders::build_decoration_sprite(const float attributes[entity_config::attributes::size], Color tint){
...
sprite::sprite sprite_builders::build_test_decoration_sprite(){
    return build_decoration_sprite(entity_config::test_decoration_attributes);
}
sprite::sprite sprite_builders::build_table_sprite(){
    return build_decoration_sprite(entity_config::table_attributes);
}
sprite::sprite sprite_builders::build_food_counter_sprite(){
    return build_decoration_sprite(entity_config::food_counter_attributes, BLUE);
}
