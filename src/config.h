...
/**
 * inline definitions for certain values like sprite dimensions, world
 * attributes key values, etc
 */
#ifndef CONFIG_H
#define CONFIG_H
...
enum directions { left = 0, right = 1, up = 2, down = 3, directions_size = 4 };
...
inline const char *khiri_left_outline_path =
    "../sprites/khiri_left_outline.png";
inline const char *khiri_right_outline_path =
    "../sprites/khiri_right_outline.png";
inline const char *khiri_up_outline_path = "../sprites/khiri_up_outline.png";
inline const char *khiri_down_outline_path =
    "../sprites/khiri_down_outline.png";
...
inline const char *mack_right_outline_path =
    "../sprites/mack_right_outline.png";
...
inline const char *gargoyle_void_path = "../sprites/gargoyle_void.png";
inline const char *gargoyle_sick_of_it_path =
    "../sprites/gargoyle_sick_of_it.png";
// sprite attributes, stored as an array of four numbers [frame width, frame
// height, frames, animations]
enum attributes {
    frame_width = 0,
    frame_height = 1,
    frames = 2,
...
inline const float background_attributes[attributes::size] = {3840.0f, 2160.0f,
                                                              1.0f, 1.0f};
inline const float cursor_attributes[attributes::size] = {25.0f, 25.0f, 1.0f,
                                                          2.0f};
inline const float paw_mark_attributes[attributes::size] = {20.0f, 20.0f, 81.0f,
                                                            1.0f};
inline const float khiri_across_attributes[attributes::size] = {
    level_config::edge_weight * 2.0f, level_config::edge_weight * 0.75f, 1.0f,
    1.0f}; // TODO update values (4/11)
inline const float khiri_down_attributes[attributes::size] = {
    level_config::edge_weight * 0.75f, level_config::edge_weight * 2.0f, 1.0f,
    1.0f}; // TODO update values (4/11)
inline const float mack_across_attributes[attributes::size] = {
    level_config::edge_weight * 2.0f, level_config::edge_weight * 0.75f, 1.0f,
    1.0f}; // TODO update values (4/11)
inline const float mack_down_attributes[attributes::size] = {
    level_config::edge_weight * 0.75f, level_config::edge_weight * 2.0f, 1.0f,
    1.0f}; // TODO update values (4/11)
inline const float test_decoration_attributes[attributes::size] = {
    level_config::edge_weight * 2.0f, level_config::edge_weight * 2.0f, 1.0f,
    1.0f}; // TODO update values (3/02)

inline const Vector2 dog_move_speed = {level_config::edge_weight,
                                       level_config::edge_weight};

} // namespace entity_config
namespace controls_config {
// controls
inline std::vector<int> mouse_controls =
    std::vector<int>{MOUSE_BUTTON_LEFT, MOUSE_BUTTON_RIGHT};
...
// ? antiicpating the need for multiple control schemes, one for the home level,
// and one for the ? resource collecting levels
} // namespace controls_config
...
inline const float edit_wheel_attributes[entity_config::attributes::size] = {
    35.0f, 35.0f, game_config::hold_duration,
    1.0f}; // for now, pending animation play speed implementation , frames is
           // 90
